...
if  ($_SESSION['ausername'] == $adminusername && $_SESSION['apassword'] == $adminpassword) {
	...
	$sql = "SELECT album,pain,parentalbum,albumdir FROM albums WHERE ain = '$ain' ";
...
<div class="options">
	<div class="aswrapper">
		<div class="iaswrapper">
			...
			<form action="createsubalbum.php" method="post">
  				<span class="boxhead"><?php echo $csalbum; ?></span><br>
	  				<input type="text" name="album" class="textbox" placeholder="<?php echo $salbum; ?>" required autofocus> 
					<input type="hidden" name="pain" value="<?php echo $_GET['ain']; ?>">
			...
			<form action="addphoto.php" method="post" multipart="" enctype="multipart/form-data" onsubmit="processing()">
				<div id="warning" class="warning"><?php echo $upwarn1; ?><br><?php echo $upwarn2; ?><br><?php echo $upwarn3; ?></div>
  				...
  				<span class="boxhead"><?php echo $aphotos; ?></span><br>
					...
					<input type="hidden" name="menu" value="subalbum">		  				
					<input type="submit" value="<?php echo $button3; ?>" class="updatebutton" name="<?php echo $create; ?>"> 
			</form>
...
<?php
	...
	$sql1 = "SELECT picpage FROM general";
	$result1 = mysqli_query($dbconnect, $sql1);						
	$row1 = mysqli_fetch_row($result1);
		$picpage = $row1[0];
	...
	$sql2 = "SELECT numpage FROM general";
...
#Photos
	...
	$sql15 = "SELECT COUNT(*) FROM photos WHERE ain = '$ain'"; 
